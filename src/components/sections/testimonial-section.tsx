...
const Testimonials = () => {
  return (
    <div className="grid gap-14 grid-cols-1 lg:grid-cols-2 items-center section">
      <div className="flex flex-col justify-center">
        ...
        <p className="sub-text-2 md:w-[90%] lg:w-4/5 mt-5 mb-4">
          It has been proven by our users that our platform is very helpful for
          those who have trouble managing tasks.
        </p>
        <div>
          <Button>
