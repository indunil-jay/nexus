...
const Window = ({ children }: WindowProps) => {
  return (
    <div className="flex flex-col items-center justify-center ">
      <div className="min-h-[18rem] bg-dark-0 relative  max-w-[25rem] outline outline-4 outline-dark-50 rounded-lg border-type-1">
        <div className="relative ml-8 mt-10 min-h-[calc(100%-2.5rem)] border-dark-200/60  border-t border-l rounded-tl-lg">
